...
class MyConvertedCode(TerraformStack):
    def __init__(self, scope, name):
        ...
        aws_instance_server = Instance(self, "server_1",
            ami=Token.as_string(property_access(server, ["keepers", "ami_id"])),
            tags={
...
<!-- cache-key: cdktf-0.17.1 input-481e7e1d76d2dd9651b63f9879c24c591e04b1977a58673585b6ad657bd0e1fc -->